...
export default function About() {
  ...
  return (
    <div id="about" className='h-full md:h-screens bg-slate-100  py-2 pb-8  md:mt-0 z-0 md:pt-24'>
      <div ref={ref} className="flex flex-col md:flex-row items-start justify-between max-w-7xl md:mx-auto gap-0 md:gap-20 px-4 md:px-2 lg:px-4 overflow-auto z-0">
        ...
        <motion.div
          ...
          className="flex-1 min-w-[200px] lg:min-w-[300px] px-1 lg:px-4 mt-16 md:mt-0"
        >
